...
var ErrAbortHandler = errors.New("github.com/robin-samuel/fhttp: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.Load() {
		panic("github.com/robin-samuel/fhttp: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.Load() {
		panic("github.com/robin-samuel/fhttp: CloseNotify called after ServeHTTP finished")
	}
